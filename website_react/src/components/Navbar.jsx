  ...
  return (
    <div className='navbar'>
        <header id="main-header">
          <h1>Ingrid's Grid</h1>
          <div id="header-pic">
              <img src="https://raw.githubusercontent.com/outofthegrid/grid-website-react/refs/heads/main/images/profile_picture.jpg" alt="Drawing of a blonde woman looking at her phone, seen from behind."/>
          </div>
        </header>
        <div className="navbar-left">
          <div className="navbar-left-sections">
